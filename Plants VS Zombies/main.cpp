...
//	pauseButtonRender.loadFromFile("pauseButton.png");
//	Texture texture; 
...
//	Image pauseButtonRender;
//	//загружаем файл для карты
//	pauseButtonRender.loadFromFile("modelSun.png");
//	Texture texture;
//	texture.loadFromImage(pauseButtonRender);
//	Sprite buttonPause;
//	buttonPause.setTexture(texture);
...
//	map_image.loadFromFile("grid.png");//загружаем файл для карты
//	Texture map;
//	map.loadFromImage(map_image);
//	Sprite s_map;
//	s_map.setTexture(map);
...
//		createBack(window);
//		vector <std::string> paths = { "Peashooter.png", "SunFlower.png", "Cabbage.png", "Shell.png", "Mine.png", "Wallnut.png" };
...
//				if ((listFlowers[i]->physic->health > 0) && (listFlowers[i]->image->currentPicture != "modelSunFlower.png") && (listFlowers[i]->image->currentPicture != "modelWallnut.png") && (listFlowers[i]->image->currentPicture != "modelMine.png")) {
...
//				Image mapLose;
//				mapLose.loadFromFile("Losing.png");
//				Texture map;
...
//			Image mapWin;
//			mapWin.loadFromFile("Victory.jpg");
//			Texture map;
